# RESTful API Node/Express Server Seed Project For Training
...
```bash
git clone https://github.com/johnnybui/node-express-mongo-training.git
cd node-express-mongo-training
```
...
This is a clone project from https://github.com/hagopj13/node-express-mongoose-boilerplate.git
